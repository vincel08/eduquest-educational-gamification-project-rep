  ...
  return (
    <PageContainer>
      ...
      <Grid container spacing={2} sx={{ mb: 2 }}>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <StatCard label="Quizzes" value={data.quizStats.length} icon={<QuizIcon />} color="#F97316" />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <StatCard
            label="Avg Progress"
      ...
      <Grid container spacing={2}>
        <Grid size={{ xs: 12, md: 7 }}>
          <Paper sx={{ p: 3, mb: 2 }}>
            <SectionHeader title="Quiz Performance" subtitle="Average scores across your quizzes" />
        ...
        <Grid size={{ xs: 12, md: 5 }}>
          <Paper sx={{ p: 3, mb: 2 }}>
            <Typography variant="h6" fontWeight={900} gutterBottom>Most Active Students</Typography>
            <List dense>
