...
async function run() {
  ...
  const [adminResult] = await connection.execute(
    `INSERT INTO users (email, password_hash, first_name, last_name, role)
     VALUES (?, ?, ?, ?, ?)`,
    ["admin@eduwow.local", passwordHash, "Alex", "Admin", "administrator"],
  );

  const [teacherResult] = await connection.execute(
    `INSERT INTO users (email, password_hash, first_name, last_name, role)
     VALUES (?, ?, ?, ?, ?)`,
    ["teacher@eduwow.local", passwordHash, "Taylor", "Teacher", "teacher"],
  );
  ...
  //     description:
  //       "Learn how to prepare for, respond to, and recover from natural and man-made disasters.",
  ...
  //         content:
  //           "Disasters can be natural (earthquakes, floods, typhoons) or human-caused (fires, chemical spills). Hazard awareness helps families identify risks in their community and reduce vulnerability through planning.",
  ...
  //         content:
  //           "A family emergency plan includes meeting points, contact numbers, evacuation routes, and assigned roles. An emergency kit should contain water, non-perishable food, flashlight, first-aid supplies, whistle, copies of IDs, and medications for at least 72 hours.",
  //         summary: "Build a family emergency plan and go-bag.",
  //         objectives:
  //           "List emergency kit items\nCreate a family communication plan\nPractice evacuation routes",
  //       },
  //       {
  //         title: "Response and Recovery",
  //         content:
  //           "During an emergency, follow Drop, Cover, and Hold for earthquakes, move to higher ground for floods, and obey official alerts. After disasters, check for injuries, avoid damaged structures, and support community recovery while managing stress and misinformation.",
  //         summary: "Respond safely and support recovery.",
  //         objectives:
  //           "Apply safety actions by hazard type\nRecognize reliable alerts\nSupport recovery and wellbeing",
  //       },
  //     ],
  //     quizQuestions: [
  //       {
  ...
  //         explanation:
  //           "Preparedness guidelines recommend at least 72 hours of supplies.",
  //         options: [
  ...
  //         type: "true_false",
  //         explanation:
  //           "This action protects the head and body from falling objects.",
  //         options: [
  ...
  //           {
  //             term: "Evacuation",
  //             definition: "Leaving a dangerous area for safety",
  //           },
  ...
  //     description:
  //       "Recognize, prevent, and respond to online harassment and digital abuse.",
  ...
  //         content:
  //           "Cyberbullying is using digital technology to harass, threaten, humiliate, or exclude someone. It can happen through social media, messaging apps, games, and emails, and may continue 24/7 beyond school grounds.",
  ...
  //         content:
  //           "Everything posted online can be copied and shared. Protect passwords, avoid sharing personal details with strangers, use privacy settings, and think before posting. Screenshots and group chats can escalate harm quickly.",
  ...
  //         content:
  //           "Bystanders can become upstanders by supporting targets, reporting abusive content, and telling a trusted adult. Keep evidence, block harassers, and use school or platform reporting tools. Empathy and clear policies reduce harm.",
  ...
  //         type: "true_false",
  //         explanation:
  //           "Online harassment is not limited to school time or campus.",
  //         options: [
  //           { text: "True", correct: true },
  //           { text: "False", correct: false },
  //         ],
  ...
  //         explanation:
  //           "Save evidence and tell a trusted adult while using block/report tools.",
  //         options: [
  //           { text: "Reply with insults", correct: false },
  //           { text: "Ignore forever and tell no one", correct: false },
  //           {
  //             text: "Document evidence and tell a trusted adult",
  //             correct: true,
  //           },
  ...
  //           {
  //             term: "Cyberbullying",
  //             definition: "Using digital tech to harass another person",
  //           },
  //           {
  //             term: "Upstander",
  //             definition: "Someone who supports the target and reports harm",
  //           },
  //           {
  //             term: "Digital footprint",
  //             definition: "Traceable online activity and posts",
  //           },
  //           {
  //             term: "Phishing",
  //             definition: "Fraudulent attempt to steal sensitive information",
  //           },
  //         ],
  //       },
  //     },
  ...
  //     description:
  //       "Build empathy, intervene safely, and create respectful school communities.",
  ...
  //         content:
  //           "Bullying is repeated aggressive behavior involving an imbalance of power. Types include physical, verbal, social/relational, and cyberbullying. Understanding forms helps students recognize harm early.",
  ...
  //         content:
  //           "Empathy means understanding others’ feelings. Respectful communication, inclusion, and celebrating differences reduce bullying. Classroom norms and peer support make schools safer.",
  ...
  //         content:
  //           "Safe intervention means helping without escalating danger: support the target, remove the audience when possible, report to adults, and avoid physical confrontation. Schools should enforce clear anti-bullying policies.",
  ...
  //         type: "true_false",
  //         explanation:
  //           "Repetition and power imbalance distinguish bullying from one-time conflict.",
  //         options: [
  //           { text: "True", correct: true },
  //           { text: "False", correct: false },
  //         ],
  ...
  //         explanation:
  //           "Support the target and report to a trusted adult rather than fighting.",
  //         options: [
  //           { text: "Start a physical fight with the bully", correct: false },
  //           {
  //             text: "Support the target and report to a trusted adult",
  //             correct: true,
  //           },
